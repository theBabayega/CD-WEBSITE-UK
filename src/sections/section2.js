                ...
                <div ref={this.refCallback} style={{ width: '100%' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', margin: '0 30px' }} >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', margin: '20px 0' }}>
                            ...
                            <div style={{ margin: '10px 0' }}><ReactCardFlip isFlipped={this.state.isFlipped1} flipDirection="horizontal">
                                <a ref={this.findHeight} onClick={this.handleClick1} style={{ display: 'flex', flexDirection: 'column', boxShadow: '#00000047 0px 3px 4px 3px', margin: '0px 0', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <img ref={this.myDiv} src={Image} alt='img' width='100%' />
                            ...
                            <div style={{ margin: '10px 0' }}><ReactCardFlip isFlipped={this.state.isFlipped2} flipDirection="horizontal">
                            ...
                            <div style={{ margin: '10px 0' }}><ReactCardFlip isFlipped={this.state.isFlipped3} flipDirection="horizontal">
                            ...
                            <div style={{ margin: '10px 0' }}><ReactCardFlip isFlipped={this.state.isFlipped4} flipDirection="horizontal">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', margin: '0 30px' }} >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly', margin: '20px 0' }}>
                            ...
                            <ReactCardFlip isFlipped={this.state.isFlipped1} flipDirection="horizontal">
                                <a onClick={this.handleClick1} style={{ display: 'flex', flexDirection: 'column', boxShadow: '#00000047 0px 3px 4px 3px', margin: '0px 0' }}>
                                    <img ref={this.myDiv} src={Image} alt='img' width={this.state.imageWidth} />
                            ...
                            <ReactCardFlip isFlipped={this.state.isFlipped2} flipDirection="horizontal">
                                <a onClick={this.handleClick2} style={{ display: 'flex', flexDirection: 'column', boxShadow: '#00000047 0px 3px 4px 3px', margin: '0px 0' }}>
                                    <img src={Image} alt='img' width={this.state.imageWidth} />
                            ...
                            <ReactCardFlip isFlipped={this.state.isFlipped3} flipDirection="horizontal">
                                <a onClick={this.handleClick3} style={{ display: 'flex', flexDirection: 'column', boxShadow: '#00000047 0px 3px 4px 3px', margin: '0px 0' }}>
                                    <img src={Image} alt='img' width={this.state.imageWidth} />
                            ...
                            <ReactCardFlip isFlipped={this.state.isFlipped4} flipDirection="horizontal">
                                <a onClick={this.handleClick4} style={{ display: 'flex', flexDirection: 'column', boxShadow: '#00000047 0px 3px 4px 3px', margin: '0px 0' }}>
                                    <img src={Image} alt='img' width={this.state.imageWidth} />
