...
import Testimonial1 from '../asset/Arup_Majumdar.png';
import Testimonial2 from '../asset/Naveen_Puri.png';
import Testimonial3 from '../asset/PC_Aggarwal.png';
import Testimonial4 from '../asset/abhayJ.jpeg';
import Testimonial5 from '../asset/rohitD.png';
import Testimonial6 from '../asset/sangamK.png';
                    ...
                    <div id="mobChange" style={{ display: 'flex', flexDirection: "row" }}>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                <h3>Solve and track medicine non-adherence from supply chain to consumption, while creating data for healthcare systems</h3>                                <br />
                                <h3>Conceptualised & tested in India. Expanding soon to the UK</h3>
                            </div>
                        </div>
